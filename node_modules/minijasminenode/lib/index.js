...
exports.pResetSpecFiles = function() {
  ...
  for (var i = 0, len = specFiles.length; i < len; ++i) {
    ...
    try {
        ...
        /* ACV OJO 201410200136 to supply specs as functions from end2end tests to protractor jasmine
         src/test/end2end/node_modules/protractor/node_modules/minijasminenode/lib
         */
        ...
        /* ACV OJO 201410270415 to allow to supply modules with protractor/jasmine test specs
           which can be re-run, by invoking a function from the module exports, if any
         */
        var aModule = require(path.resolve(process.cwd(), filename));
        if( aModule && ( typeof aModule == "function")) {
            aModule();
        }
    } catch (e) {
